  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container p-10 mx-auto">
        <h1 className="text-4xl font-bold text-gray-700 mb-6">Financial Statements</h1>
        <div>
          ...
          <div>
            ...
            <form className="my-6">
              <h2 className="text-xl font-semibold text-gray-700 mb-2">Add new transaction</h2>
              <div className="flex justify-between bg-white items-center border-2 rounded-md p-4 mb-6">
                <div className="md:p-4 py-2 px-2 w-2/3">
                  ...
                  <div className="flex items-center">
                    <input type="text" placeholder="New shiny thing" className="p-2 w-full border-2 rounded-md outline-none" />
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 ml-2" fill="none"
                ...
                <div className="md:p-4 py-2 px-2">
                  ...
                  <div className="flex items-center">
                    <input type="text" placeholder="100.00" className="p-2 border-2 w-full rounded-md outline-none" />
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 ml-2" fill="none"
                      viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                        d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
              ...
              <div className="mt-4 p-2 space-x-2">
                <button className="text-md bg-red-500 px-5 py-2 rounded-md text-white">Cancel</button>
                <span className="text-lg font-semibold">Or</span>
                <button className="text-md bg-green-500 px-8 py-2 rounded-md text-white">Ok</button>
              </div>
            </form>
          </div>
        </div>
