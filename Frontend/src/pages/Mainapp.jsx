            ...
            <div className="flex flex-col items-center mx-20 shadow-xl w-60 card bg-base-100">
              ...
              <div className="card-body">
                ...
                <div className="justify-center card-actions">
                  <Link to={"/appform"}>
                    <button className="btn px-6 py-3 font-semibold text-white bg-orange-500 hover:bg-orange-600 rounded-md">
                      Book Now
                    </button>
                  </Link>
                </div>
                  ...
                  <td className="kasun">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="mx-20 text-sm opacity-50">
                          Male coach
                        </div>
                      </div>
                    </div>
