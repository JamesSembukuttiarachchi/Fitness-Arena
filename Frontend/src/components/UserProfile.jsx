...
const UserProfile = () => {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:6005/api/users/${id}`, {
        method: "PUT",
        headers: {
  ...
  return (
    <Layout>
      <div className="max-w-lg mx-auto m-10 flex flex-col items-center border border-gray-400 rounded-md p-4">
        <div className="m-4">
        ...
        <div className="m-4">
          ...
          <div className="flex justify-center gap-4">
            ...
            <button
              ...
              className="btn btn-sm bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline text-center"
            >
        ...
        <Link to={`/save/`}>
          <button className="btn btn-primary">Save Cards</button>
        </Link>
        </div>
